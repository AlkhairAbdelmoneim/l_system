    ...
    <div class="content-wrapper">
        <section class='content-header'>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">كل العناوين</li>
            </ol>
        </section>
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title" style="margin-bottom: 15px">العناوين<small
                    ...
                    <form action="{{ route('address.index') }}" method="GET">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('address.create') }}" class="btn btn-primary"><i
                        ...
                        <tbody>
                            @foreach ($address as $index => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->command }}</td>
                                    <td>
                                        <a href="{{ route('address.edit', $item->id) }}" class="btn btn-info btn-sm"><i
