        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title" style="margin-bottom: 15px">العمل<small
                    ...
                    <form action="{{ route('work.index') }}" method="GET">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('work.create') }}" class="btn btn-primary"><i
                        ...
                        <tbody>
                            @foreach ($works as $index => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->command }}</td>
                                    <td>
                                        <a href="{{ route('work.edit', $item->id) }}" class="btn btn-info btn-sm"><i
                                                class="fa fa-edit"></i>@lang('site.edit')</a>

                                        <form method="post" action="{{ route('work.destroy', $item->id) }}"
