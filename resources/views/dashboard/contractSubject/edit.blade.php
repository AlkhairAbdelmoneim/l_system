        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('contractSubject.update' ,$contractSub->id) }}" method="POST">
                        @csrf
                        {{ method_field('put') }}

                        <div class="form-group">
                            <label>إسم موضوع العقد</label>
                            <input type="text" name="contract_subject_name" class="form-control" value="{{$contractSub->contract_subject_name}}">
                        </div>
