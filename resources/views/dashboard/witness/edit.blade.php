    ...
    <div class="content-wrapper">
        <section class='content-header'>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('witness.index') }}">الشهود</a></li>
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('witness.update',$witness->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            <label>إسم الشاهد</label>
                            <input type="text" name="witness_name" class="form-control" value="{{$witness->witness_name}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="personal_identity_type" class="form-control" value="{{$witness->personal_identity_type}}">
                        </div>

                        <div class="form-group">
                            <label>رقم اثبات الشخصية</label>
                            <input type="text" name="personal_identity_no" class="form-control" value="{{$witness->personal_identity_no}}">
                        </div>

                        <div class="form-group">
                            <label>رقم الهاتف</label>
                            <input type="text" name="phone_no" class="form-control" value="{{$witness->phone_no}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="state_name" class="form-control" style="height: 40px">
                                @foreach ($states as $key => $value)
                                    <option value="{{ $value->id}}" @if ($witness->state_name == $value->id)
                                        selected
                            ...
                            <select name="local_name" class="form-control" style="height: 40px">
                                @foreach ($locals as $key => $value)
                                    <option value="{{ $value->id }}"
                                        @if ($witness->local_name == $value->id)
                                        selected
                        ...
                        <div class="form-group">
                            ...
                            <select name="administrative_unit_name" class="form-control" style="height: 40px">
                                @foreach ($administrativeUnit as $key => $value)
                                    <option value="{{ $value->id }}" @if ($witness->administrative_unit_name  == $value->id)
                                        selected
