    ...
    <div class="content-wrapper">
        <section class='content-header'>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('customersTo.index') }}">المدعى عليه</a></li>
        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('customersTo.update',$customer->id) }}" method="POST">
                        @csrf
                        {{ method_field('put') }}

                        <div class="form-group">
                            <label>إسم العميل</label>
                            <input type="text" name="customerTo_name" class="form-control" value="{{$customer->customerTo_name}}">
                        </div>
