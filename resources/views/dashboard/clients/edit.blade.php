    ...
    <div class="content-wrapper">
        <section class='content-header'>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('clients.index') }}">الموكل</a></li>
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('clients.update',$clients->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="personal_identity_type" class="form-control" value="{{$clients->personal_identity_type}}">
                        </div>

                        <div class="form-group">
                            <label>رقم اثبات الشخصية</label>
                            <input type="text" name="personal_identity_no" class="form-control" value="{{$clients->personal_identity_no}}">
                        </div>

                        <div class="form-group">
                            <label>رقم الهاتف</label>
                            <input type="text" name="phone_no" class="form-control" value="{{$clients->phone_no}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="state_name" class="form-control" style="height: 40px">
                                @foreach ($states as $key => $value)
                                    <option value="{{ $value->id}}" @if ($clients->state_name == $value->id)
                                        selected
                            ...
                            <select name="local_name" class="form-control" style="height: 40px">
                                @foreach ($locals as $key => $value)
                                    <option value="{{ $value->id }}"
                                        @if ($clients->local_name == $value->id)
                                        selected
                        ...
                        <div class="form-group">
                            ...
                            <select name="administrative_unit_name" class="form-control" style="height: 40px">
                                @foreach ($administrativeUnit as $key => $value)
                                    <option value="{{ $value->id }}" @if ($clients->administrative_unit_name  == $value->id)
                                        selected
