                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown messages-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">لديك {{-- messages('countMessage') --}} رسالة جديدة</li>
                                <li>
                                ...
                                <li class="footer">
                                    <a href="{{-- route('contact_us.index') --}}">كل الرسائل</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">لديل {{-- getBuActiveOrNot(0) --}} عقار بإنتظار التفعيل</li>
                                <li>
                                    {{-- <!-- inner menu: contains the actual data --> --}}
                                    <ul class="menu">
{{-- 
                                ...
                                <li class="footer">
                                    <a href="{{-- route('building') --}}">عرض الكل</a>
                                </li>
                            </ul>
                        </li>
