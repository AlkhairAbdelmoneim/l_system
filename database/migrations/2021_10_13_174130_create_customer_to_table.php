...
class CreateCustomerToTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customerTo', function (Blueprint $table) {
            $table->id();
            $table->string('customerTo_name' , 35);
    ...
    {
        Schema::dropIfExists('customer_to');
    }
}
